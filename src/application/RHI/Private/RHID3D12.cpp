...
//void RHID3D12Context::Initialize(IRHIPlatformSupport* PlatformSupport)
//{
//    auto* D3D12PlatformSupport = static_cast<RHID3D12PlatformSupport*>(PlatformSupport);
...
//void RHID3D12WindowManager::Initialize(IRHIPlatformSupport* PlatformSupport, uint32_t WindowHeight, uint32_t WindowWidth)
//{
//    auto* D3D12PlatformSupport = static_cast<RHID3D12PlatformSupport*>(PlatformSupport);
...
//}
//
//void RHID3D12WindowManager::Cleanup(IRHIPlatformSupport* PlatformSupport)
//{
//    auto* D3D12PlatformSupport = static_cast<RHID3D12PlatformSupport*>(PlatformSupport);
//    // Placeholder implementation
//}
//
//void RHID3D12WindowManager::InitializeSwapchain(IRHIContext* Context, IRHIPlatformSupport* PlatformSupport)
//{
...
//}
//
//void RHID3D12WindowManager::CleanupSwapchain(IRHIContext* Context)
//{
//    auto* D3D12Context = static_cast<RHID3D12Context*>(Context);
...
//}
//
//void RHID3D12WindowManager::RecreateSwapchain(IRHIContext* Context)
//{
//    auto* D3D12Context = static_cast<RHID3D12Context*>(Context);
//    D3D12Context->WaitForPreviousFrame();
...
//}
//
//void RHID3D12WindowManager::AddScreenSizeTexture(IRHIImageResource* ImageResource)
//{
//	
//}
//
//void RHID3D12WindowManager::InitializeRenderPassAsPresent(IRHIRenderPass* OutRenderPass, IRHIContext* Context)
//{
//    auto* D3D12Context = static_cast<RHID3D12Context*>(Context);
//    auto* D3D12RenderPass = static_cast<RHID3D12RenderPass*>(OutRenderPass);
...
//}
//
//void RHID3D12WindowManager::RemoveScreenSizeTexture(IRHIImageResource* ImageResource)
//{
//	
//}
//
...
//
//
//void RHID3D12ImageResource::InitializeRenderTarget(IRHIContext* Context, IRHIWindowManager* WindowManager, ImageExtent3D RTExtent, RHIResourceState InUsage, uint32_t MultiSamplesCount)
//{/*
//    auto* D3D12Context = static_cast<RHID3D12Context*>(Context);
//    auto* D3D12WindowManager = static_cast<RHID3D12WindowManager*>(WindowManager);
//
...
//}
//
//void RHID3D12PipelineFactory::InitializePipelineObject(IRHIPipelineObject* OutPipelineObject, IRHIContext* Context, IRHIPresentPass* PresentPassResource)
//{
//    
//}
//
...
//void RHID3D12GraphicsDispatcher::Initialize(IRHIContext* Context)
//{
//    auto* D3D12Context = static_cast<RHID3D12Context*>(Context);
//
//    // Create the command list.
...
//}
//
//void RHID3D12GraphicsDispatcher::Cleanup(IRHIContext* Context, IRHIWindowManager* WindowManager)
//{
//    auto* D3D12Context = static_cast<RHID3D12Context*>(Context);
//    auto* D3D12WindowManager = static_cast<RHID3D12WindowManager*>(WindowManager);
//
//}
//
//void RHID3D12GraphicsDispatcher::BindVertexBuffer(IRHIBufferResource* BufferResource, uint32_t Offset, uint32_t BindingIndex)
//{
...
//}
//
//void RHID3D12GraphicsDispatcher::BindIndexBuffer(IRHIBufferResource* BufferResource, uint32_t Offset)
//{
...
//}
//
//void RHID3D12GraphicsDispatcher::Draw(IRHICommandBuffer* CommandBuffer, IRHIPipelineObject* Pipeline, uint32_t IndexCount, uint32_t IndexOffset, uint32_t InstanceCount)
//{
//    auto* D3D12Pipeline = static_cast<RHID3D12PipelineObject*>(Pipeline);
//
...
//}
//
//void RHID3D12GraphicsDispatcher::BeginRenderPass(IRHICommandBuffer* CommandBuffer, IRHIRenderPass* RenderPass, IRHIFrameBuffer* Framebuffer)
//{
//    auto* D3D12RenderPass = static_cast<RHID3D12RenderPass*>(RenderPass);
...
//}
//
//void RHID3D12GraphicsDispatcher::EndFrameAndSubmit(IRHICommandBuffer* CommandBuffer, IRHIContext* Context, IRHIWindowManager* WindowManager, IRHIFrameBuffer* PresentFrameBuffer)
//{
...
//
//
//void RHID3D12GraphicsDispatcher::EndRenderPass(IRHICommandBuffer* CommandBuffer, IRHIRenderPass* RenderPass)
//{
//}
//
//
//void RHID3D12GraphicsDispatcher::BeginFrame(IRHICommandBuffer* CommandBuffer, IRHIContext* Context, IRHISwapchain* Swapchain, IRHIRenderPass* PresentRenderPass)
//{
//    auto* D3D12Context = static_cast<RHID3D12Context*>(Context);
//    auto* D3D12Swapchain = static_cast<RHID3D12Swapchain*>(Swapchain);
//    auto* D3D12PresentRenderPass = static_cast<RHID3D12RenderPass*>(PresentRenderPass);
//
...
//}
//
//void RHID3D12GraphicsDispatcher::WaitForGPUIdle(IRHIContext* Context)
//{
//}
//
//// RHID3D12ComputeDispatcher implementation
//void RHID3D12ComputeDispatcher::Initialize(IRHIContext* Context)
//{
//	auto* D3D12Context = static_cast<RHID3D12Context*>(Context);
//	
...
//}
//
//void RHID3D12ComputeDispatcher::Cleanup(IRHIContext* Context)
//{
//	// Command list will be cleaned up automatically by ComPtr
//}
//
//void RHID3D12ComputeDispatcher::Dispatch(IRHICommandBuffer* CommandBuffer, IRHIPipelineObject* PipelineObject, uint32_t ThreadGroupX, uint32_t ThreadGroupY, uint32_t ThreadGroupZ)
//{
//	auto* D3D12Pipeline = static_cast<RHID3D12PipelineObject*>(PipelineObject);
//	
...
//}
//
//void RHID3D12ComputeDispatcher::WaitForGPUIdle(IRHIContext* Context)
//{
//	auto* D3D12Context = static_cast<RHID3D12Context*>(Context);
//	D3D12Context->WaitForPreviousFrame();
//}
//
//void RHID3D12GraphicsDispatcher::TransitionImageAsRenderTarget(IRHICommandBuffer* CommandBuffer, IRHIImageResource* Image)
//{
//}
//
//void RHID3D12GraphicsDispatcher::TransitionImageAsShaderRead(IRHICommandBuffer* CommandBuffer, IRHIImageResource* Image)
//{
//}
//
//void RHID3D12RenderPass::Initialize(IRHIContext* Context, std::vector<RHIFormat> ColorRTFormats, bool hasDepth, RHIFormat DepthFormat)
//{
//
//}
//
//
////void RHID3D12RenderPass::AddColorRenderTarget(IRHIImageResource* ColorRT)
////{
////    auto* D3D12ColorRT = static_cast<RHID3D12ImageResource*>(ColorRT);
...
////}
////
////void RHID3D12RenderPass::SetDepthRenderTarget(IRHIImageResource* InDepthRT)
////{
////    auto* D3D12DepthRT = static_cast<RHID3D12ImageResource*>(InDepthRT);
...
//
//
//void RHID3D12PresentPass::Cleanup(IRHIContext* Context)
//{
//}
//
//void RHID3D12PresentPass::Initialize(IRHIContext* Context, IRHIWindowManager* WindowManager, uint32_t MSAASamples, IRHIImageResource* ColorRT, IRHIImageResource* DepthRT)
//{
//    auto* D3D12Context = static_cast<RHID3D12Context*>(Context);
//    D3D12Context->WaitForPreviousFrame();
//}
//
//void RHID3D12PresentPass::OnWindowResize(IRHIContext* Context, IRHIWindowManager* WindowManager)
//{
//    auto* D3D12Context = static_cast<RHID3D12Context*>(Context);
//    auto* D3D12WindowManager = static_cast<RHID3D12WindowManager*>(WindowManager);
//    D3D12Context->WaitForPreviousFrame();
...
//void RHID3D12ImGUI::Initialize(IRHIContext* Context, IRHIWindowManager* WindowManager, IRHISwapchain* Swapchain, IRHIRenderPass* PresentRenderPass)
//{
//    auto* D3D12Context = static_cast<RHID3D12Context*>(Context);
//    auto* D3D12WindowManager = static_cast<RHID3D12WindowManager*>(WindowManager);
//    //auto* D3D12PresentPass = static_cast<RHID3D12PresentPass*>(PresentPass);
...
//}
//
//void RHID3D12ImGUI::DispatchImGUI(IRHICommandBuffer* CommandBuffer, IRHIGraphicsDispatcher* Dispatcher)
//{
//    auto* D3D12Dispatcher = static_cast<RHID3D12GraphicsDispatcher*>(Dispatcher);
//
//    MSG msg;
...
//}
//
//void RHID3D12Swapchain::Initialize(IRHIContext* Context, IRHIWindowManager* WindowManager)
//{
//	
//}
//
...
//}
//
//void RHID3D12Swapchain::PresentFrameAndRelease(IRHIContext* Context, IRHICommandBuffer* CommandBuffer, IRHIGraphicsDispatcher* GDispatcher)
//{
//	
//}
//
